...
public class 1002{
    ...
    static int mazePath_HVD_jump(int sr,int sc,int er,int ec,String ans){
        if(sr==er && sc==ec){
            System.out.println(ans);
            return 1;
        }
    ...
    static boolean KnightTour(int[][] board,int sr,int sc,int steps){
    ...
    static int coinChangePermutation_01(int[] coins,int tar,String ans){
      if(tar==0){
        System.out.println(ans);
        return 1;
      }
    ...
    static int coinChangeCombination_01(int[] coins,int idx,int tar,String ans){
      if(tar==0){
        System.out.println(ans);
        return 1;
      }
    ...
    static int coinChangeCombinationSingle_01(int[] coins,int idx,int tar,String ans){
      if(tar==0){
        System.out.println(ans);
        return 1;
      }
    ...
    static int coinChangePermutationSingle_01(int[] coins,int tar,boolean[] vis,String ans){
      if(tar==0){
        System.out.println(ans);
        return 1;
      }
    ...
    static int coinChangeCombinationSingleSubseq_01(int[] coins,int idx,int tar,String ans){
    ...
    static int coinChangeCombinationSubseq_01(int[] coins,int idx,int tar,String ans){
      if(tar==0 || idx >= coins.length){
        if(tar==0){
          System.out.println(ans);
          return 1;
    ...
    static int coinChangePermutationSubSeq_01(int[] coins,int idx,int tar,String ans){
      if(tar==0 || idx >= coins.length){
        if(tar==0){
          System.out.println(ans);
          return 1;
    ...
    static int coinChangePermutationSingleSubSeq_01(int[] coins,int idx,int tar,boolean[] vis,String ans){
      if(tar==0 || idx >= coins.length){
        if(tar==0){
          System.out.println(ans);
          return 1;
